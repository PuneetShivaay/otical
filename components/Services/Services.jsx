        ...
        {services.map((service, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <Link href={service.href}>
              <div className="bg-neutral-800/50 p-8 rounded-2xl border border-neutral-700 h-full transition-all duration-300 hover:border-orange-500 hover:shadow-xl hover:shadow-orange-500/15 transform hover:-translate-y-2">
